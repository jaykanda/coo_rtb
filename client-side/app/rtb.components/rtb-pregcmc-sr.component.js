...
var RTBPreGCMCSRComponent = (function () {
    function RTBPreGCMCSRComponent(_fb, myRTBNewRequestService, toolTipservice) {
        this._fb = _fb;
    ...
    RTBPreGCMCSRComponent.prototype.ngOnInit = function () {
    ...
    RTBPreGCMCSRComponent.prototype.calTotalAmount = function () {
        var totalCost = 0;
    ...
    RTBPreGCMCSRComponent.prototype.calTotalVatAmount = function () {
        this.calTotalAmount();
        var tva = 0;
    ...
    RTBPreGCMCSRComponent.prototype.setBusinessUnit = function () {
        this.BusinessUnitList = this.myRTBNewRequestService.getBusinessUnitList(this.RTBSpendRequest.Division.Id);
    };
    RTBPreGCMCSRComponent.prototype.setHeadOfSystem = function () {
    ...
    RTBPreGCMCSRComponent.prototype.setAreaHeadOfSystem = function () {
    ...
    RTBPreGCMCSRComponent.prototype.saveRequestAsDraft = function () {
    ...
    RTBPreGCMCSRComponent.prototype.discardRequest = function () {
        if (this.RTBSpendRequest.RequestID != null || this.RTBSpendRequest.RequestID != "") {
            this.myRTBNewRequestService.discardRTBRequest(this.RTBSpendRequest.RequestID);
        }
        console.log("discardRequest");
    };
    RTBPreGCMCSRComponent.prototype.dynStakeHolderSection = function () {
    ...
    RTBPreGCMCSRComponent.prototype.dynFinanceInfoSection = function () {
        return this._fb.group({
            dynYear: [''],
            dynBudget: [''],
            dynFrCst: [''],
    ...
    RTBPreGCMCSRComponent.prototype.isFieldValid = function (field) {
        return !this.newSRForm.controls[field].valid && this.newSRForm.controls[field].touched && this.newRequestFlag;
    };
    RTBPreGCMCSRComponent.prototype.displayFieldCss = function (field) {
        return {
            'has-error': this.isFieldValid(field),
            'has-feedback': this.isFieldValid(field)
        };
    };
    RTBPreGCMCSRComponent.prototype.reviewRequest = function () {
        this.newRequestFlag = false;
    ...
    ;
    RTBPreGCMCSRComponent.prototype.modifyRequest = function () {
        this.newRequestFlag = true;
        console.log("modifyRequest");
    };
    ;
    RTBPreGCMCSRComponent.prototype.addRow = function () {
    ...
    ;
    RTBPreGCMCSRComponent.prototype.deleteRow = function (id) {
        var control = this.newSRForm.controls['dynstakeHolderFields'];
        control.removeAt(id);
    ...
    ;
    RTBPreGCMCSRComponent.prototype.addFinanceRow = function () {
    ...
    ;
    RTBPreGCMCSRComponent.prototype.deleteFinanceRow = function (finId) {
        var control = this.newSRForm.controls['dynFinanceInfoFields'];
        control.removeAt(finId);
    };
    ;
    RTBPreGCMCSRComponent.prototype.onChangeFields = function () {
        this.selectedOption = this.RTBSpendRequest.AmountToSpend.Name;
        console.log(this.selectedOption);
    };
    ;
    RTBPreGCMCSRComponent.prototype.autoSuggest = function (keycode, keyupVal) {
        var trimmedStr = "";
        if (keycode === 32) {
    ...
    RTBPreGCMCSRComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: "rtb-new-sr",
    ...
    return RTBPreGCMCSRComponent;
}());
exports.RTBPreGCMCSRComponent = RTBPreGCMCSRComponent;
//# sourceMappingURL=rtb-pregcmc-sr.component.js.map