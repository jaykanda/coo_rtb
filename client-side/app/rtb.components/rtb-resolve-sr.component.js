...
var RTBResolveSRComponent = (function () {
    function RTBResolveSRComponent(_fb, myRTBNewRequestService, toolTipservice) {
        this._fb = _fb;
    ...
    RTBResolveSRComponent.prototype.ngOnInit = function () {
    ...
    RTBResolveSRComponent.prototype.calTotalAmount = function () {
        var totalCost = 0;
    ...
    RTBResolveSRComponent.prototype.calTotalVatAmount = function () {
        this.calTotalAmount();
        var tva = 0;
        tva = this.RTBSpendRequest.TotalSpendAmount * this.RTBSpendRequest.Vat;
        if (tva != 0) {
    ...
    RTBResolveSRComponent.prototype.setBusinessUnit = function () {
        this.BusinessUnitList = this.myRTBNewRequestService.getBusinessUnitList(this.RTBSpendRequest.Division.Id);
    };
    RTBResolveSRComponent.prototype.setHeadOfSystem = function () {
    ...
    RTBResolveSRComponent.prototype.setAreaHeadOfSystem = function () {
    ...
    RTBResolveSRComponent.prototype.saveRequestAsDraft = function () {
    ...
    RTBResolveSRComponent.prototype.discardRequest = function () {
        if (this.RTBSpendRequest.RequestID != null || this.RTBSpendRequest.RequestID != "") {
            this.myRTBNewRequestService.discardRTBRequest(this.RTBSpendRequest.RequestID);
        }
        console.log("discardRequest");
    };
    RTBResolveSRComponent.prototype.dynStakeHolderSection = function () {
    ...
    RTBResolveSRComponent.prototype.dynFinanceInfoSection = function () {
        return this._fb.group({
            dynYear: [''],
            dynBudget: [''],
            dynFrCst: [''],
    ...
    RTBResolveSRComponent.prototype.isFieldValid = function (field) {
        return !this.newSRForm.controls[field].valid && this.newSRForm.controls[field].touched && this.newRequestFlag;
    };
    RTBResolveSRComponent.prototype.displayFieldCss = function (field) {
        return {
            'has-error': this.isFieldValid(field),
            'has-feedback': this.isFieldValid(field)
        };
    };
    RTBResolveSRComponent.prototype.reviewRequest = function () {
    ...
    ;
    RTBResolveSRComponent.prototype.modifyRequest = function () {
        this.newRequestFlag = true;
        console.log("modifyRequest");
    };
    ;
    RTBResolveSRComponent.prototype.addRow = function () {
    ...
    ;
    RTBResolveSRComponent.prototype.deleteRow = function (id) {
        var control = this.newSRForm.controls['dynstakeHolderFields'];
        control.removeAt(id);
    ...
    ;
    RTBResolveSRComponent.prototype.addFinanceRow = function () {
    ...
    ;
    RTBResolveSRComponent.prototype.deleteFinanceRow = function (finId) {
        var control = this.newSRForm.controls['dynFinanceInfoFields'];
        control.removeAt(finId);
    };
    ;
    RTBResolveSRComponent.prototype.onChangeFields = function () {
        this.selectedOption = this.RTBSpendRequest.AmountToSpend.Name;
        console.log(this.selectedOption);
    };
    ;
    RTBResolveSRComponent.prototype.autoSuggest = function (keycode, keyupVal) {
        var trimmedStr = "";
        if (keycode === 32) {
    ...
    RTBResolveSRComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: "rtb-resolve-sr",
            templateUrl: '../rtb.templates/rtb-resolve-sr.component.html',
        }), 
    ...
    return RTBResolveSRComponent;
}());
exports.RTBResolveSRComponent = RTBResolveSRComponent;
//# sourceMappingURL=rtb-resolve-sr.component.js.map